...
export function MCPProvider({ children }: MCPProviderProps) {
  ...
  const initializeMCP = async () => {
    ...
    try {
      console.log("🔌 Initializing MCP connection for frontend...");
      ...
      setClient(mcpClient);
      setIsConnected(true);
      console.log("✅ MCP connection established for frontend");
      ...
      setClient(null);
      console.error("❌ Frontend MCP initialization failed:", errorMessage);
    } finally {
